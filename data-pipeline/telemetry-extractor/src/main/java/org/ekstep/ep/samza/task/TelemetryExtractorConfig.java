...
public class TelemetryExtractorConfig {
	...
	private String devConSuccessTopic;
	...
	public TelemetryExtractorConfig(Config config) {
		...
		devConSuccessTopic = config.get("output.devcon.success.topic.name", "telemetry.devcon");
	...
	public String devConSuccessTopic() {
		return devConSuccessTopic;
	}
